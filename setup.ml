...
(* OASIS_START *)
(* DO NOT EDIT (digest: b15615bc7beacd0404c44b273627b681) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Kakadu"];
          homepage = None;
          synopsis = "Parser for chess Portable Game Notation (PGN)";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["PgnParser"];
                      lib_pack = false;
                      lib_internal_modules = ["PgnLexer"];
     ...
     oasis_digest = Some "k\153jjt(J\151\250\143\162\228\235\184\253\130";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
